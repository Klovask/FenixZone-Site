...
<style>.ft1{width:300px;float:left;padding:10px;margin-left:35px;}.ft2{width:300px;float:left;padding:10px;}.ft1 img{background-color:#FFFFFF;padding:5px;border:solid 1px #CCCCCC;width:250px;height:150px}.ft2 img{background-color:#FFFFFF;padding:5px;border:solid 1px #CCCCCC;width:250px;height:150px}.datos2{background-color:#FFFFFF;padding:5px;float:left;width:250px;border-left:solid 1px #CCCCCC;border-right:solid 1px #CCCCCC;border-bottom:solid 1px #CCCCCC;}.datos2 span{text-align:right;float:right;font-weight:bold}.ft1 a{background-image:url(./imagenes/carrito.png);background-repeat:no-repeat;height:16px;padding-left:20px;width:0;float:right;overflow:hidden;margin-left:5px;}.ft2 a{background-image:url(./imagenes/carrito.png);background-repeat:no-repeat;height:16px;padding-left:20px;width:0;float:right;overflow:hidden;margin-left:5px;}</style>
...
<a href="./cuenta.php" title="Tu cuenta"><img src="./imagenes/casa.png" align="absmiddle" border="0"/></a> &nbsp;
<a href="./logout.php" title="Cerrar sesi&oacute;n - Salir"><img src="./imagenes/llave_salir.png" align="absmiddle" border="0"/></a>
</div>
</div>
...
<?php  if(isset($_POST['enviar'])) { $cc1 = $_POST['color1']; $cc2 = $_POST['color2']; $auto = $_POST['veh']; if(validarCadena($auto) == true) { if($auto == 1) { if(isset($_POST['color1']) && isset($_POST['color2'])) { if(validarCadenaColor($_POST['color1']) == true && validarCadenaColor($_POST['color2']) == true) { if($estaonline == 0) { if($fz > 2) { $stmt = $con->prepare("UPDATE usuarios SET Moneda = Moneda-3 WHERE Username = :usuario"); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $stmt = $con->prepare("UPDATE usuarios SET Color1 = :ccc1, Color2 = :ccc2 WHERE Username= :usuario"); $stmt->bindParam(':ccc1', $cc1, PDO::PARAM_INT); $stmt->bindParam(':ccc2', $cc2, PDO::PARAM_INT); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $fz = $fz-3; echo '<div class="login" style="padding:5px;top:20px;background-color:#06AD00; color:#FFFFFF; width:667px; text-align:center;"><strong>Veh&iacute;culo pintado correctamente (-3';?><?php echo $Diminutivo?><?php echo ")";?><?php echo '</strong></div>'; } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>No tienes los ';?><?php echo $Diminutivo?><?php echo ' necesarios (3)</strong></div>'; } } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>Tienes que estar desconectado para poder pintar tu vehiculo.</strong></div>'; } } } } if($auto == 2) { if(isset($_POST['color1']) && isset($_POST['color2'])) { if(validarCadenaColor($_POST['color1']) == true && validarCadenaColor($_POST['color2']) == true) { if($estaonline == 0) { if($fz > 2) { $stmt = $con->prepare("UPDATE usuarios SET Moneda = Moneda-3 WHERE Username = :usuario"); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $stmt = $con->prepare("UPDATE usuarios SET 2Color1 = :ccc1, 2Color2 = :ccc2 WHERE Username= :usuario"); $stmt->bindParam(':ccc1', $cc1, PDO::PARAM_INT); $stmt->bindParam(':ccc2', $cc2, PDO::PARAM_INT); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $fz = $fz-3; echo '<div class="login" style="padding:5px;top:20px;background-color:#06AD00; color:#FFFFFF; width:667px; text-align:center;"><strong>Veh&iacute;culo pintado correctamente (-3';?><?php echo $Diminutivo?><?php echo ")";?><?php echo '</strong></div>'; } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>No tienes los ';?><?php echo $Diminutivo?><?php echo ' necesarios (3)</strong></div>'; } } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>Tienes que estar desconectado para poder pintar tu vehiculo.</strong></div>'; } } } } if($auto == 3) { if(isset($_POST['color1']) && isset($_POST['color2'])) { if(validarCadenaColor($_POST['color1']) == true && validarCadenaColor($_POST['color2']) == true) { if($estaonline == 0) { if($fz > 2) { $stmt = $con->prepare("UPDATE usuarios SET Moneda = Moneda-3 WHERE Username = :usuario"); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $stmt = $con->prepare("UPDATE usuarios SET 3Color1 = :ccc1, 3Color2 = :ccc2 WHERE Username= :usuario"); $stmt->bindParam(':ccc1', $cc1, PDO::PARAM_INT); $stmt->bindParam(':ccc2', $cc2, PDO::PARAM_INT); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $fz = $fz-3; echo '<div class="login" style="padding:5px;top:20px;background-color:#06AD00; color:#FFFFFF; width:667px; text-align:center;"><strong>Veh&iacute;culo pintado correctamente (-3';?><?php echo $Diminutivo?><?php echo ")";?><?php echo '</strong></div>'; } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>No tienes los ';?><?php echo $Diminutivo?><?php echo ' necesarios (3)</strong></div>'; } } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>Tienes que estar desconectado para poder pintar tu vehiculo.</strong></div>'; } } } } if($auto == 4) { if(isset($_POST['color1']) && isset($_POST['color2'])) { if(validarCadenaColor($_POST['color1']) == true && validarCadenaColor($_POST['color2']) == true) { if($estaonline == 0) { if($fz > 2) { $stmt = $con->prepare("UPDATE usuarios SET Moneda = Moneda-3 WHERE Username = :usuario"); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $stmt = $con->prepare("UPDATE usuarios SET 4Color1 = :ccc1, 4Color2 = :ccc2 WHERE Username= :usuario"); $stmt->bindParam(':ccc1', $cc1, PDO::PARAM_INT); $stmt->bindParam(':ccc2', $cc2, PDO::PARAM_INT); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); $fz = $fz-3; echo '<div class="login" style="padding:5px;top:20px;background-color:#06AD00; color:#FFFFFF; width:667px; text-align:center;"><strong>Veh&iacute;culo pintado correctamente (-3';?><?php echo $Diminutivo?><?php echo ")";?><?php echo '</strong></div>'; } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>No tienes los ';?><?php echo $Diminutivo?><?php echo ' necesarios (3)</strong></div>'; } } else { echo '<div class="login" style="padding:5px;top:20px;background-color:#F00; color:#FFFFFF; width:667px; text-align:center;"><strong>Tienes que estar desconectado para poder pintar tu vehiculo.</strong></div>'; } } } } if($auto > 4) { ?>	
		<script language="javascript">alert("Error 3");</script>
<?php  session_start(); session_destroy(); echo "<script>window.location='index.php';</script>"; } } else { ?>
	<script language="javascript">alert("Error 4");</script>
<?php  session_start(); session_destroy(); echo "<script>window.location='index.php';</script>"; } } ?>



<div id="contenido-izquierdo">
<div class="td-gr">
<div class="icono-td"><img src="imagenes/auto2.png"/></div>
<div style="height:22px;font-weight:bold; font-size:14px;text-shadow:0 1px 0 #FFFFFF;color:#305B79;padding-top:8px; margin-left:10px; margin-left:34px">Veh&iacute;culos</div>
...
<div style="border: solid 1px #999999; margin-left:173px; padding:5px;margin-right:173px; background-color:#F5F5F5"><img src="imagenes/autos-miniatura/<?php echo $autocoche?>.gif"/></div>
</td>
</tr>
...
<tr>
<td height="44" valign="middle" bgcolor="#FFFFFF" width="250">&nbsp;<font size="2px">Color principal: </td>
...
<div style="float:left; width:40px; height:40px; margin-left:5px;"><img src="imagenes/baldes.gif" align="absmiddle" style="cursor:pointer" alt="Seleccionar color" title="Seleccionar color" id="cambiar-color1"/></div>
...
<tr>
<td height="44" valign="middle" bgcolor="#FFFFFF">&nbsp;<font size="2px">Color secundario: </td>
<td align="center" valign="middle" bgcolor="#FFFFFF">
...
<div style="float:left; width:40px; height:40px; margin-left:5px;"><img src="imagenes/baldes.gif" align="absmiddle" style="cursor:pointer" alt="Seleccionar color" title="Seleccionar color" id="cambiar-color2"/></div>
...
<tr>
<td height="44" valign="middle" bgcolor="#FFFFFF">&nbsp;<font size="2px">Costo: </td>
...
<hr/>
<input name="enviar" type="submit" value="Cambiar color"/><hr/>
<hr/>
</td>
</tr>
</table>
...
<div id="pie"><hr><?php echo $NombreServidor?> Roleplay &copy; 2015 - 18</div> </td>
</tr>
</table>
</body>
