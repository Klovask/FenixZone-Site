<?php  require_once "seguridad/sql_inject.php"; $bDestroy_session = TRUE; $url_redirect = 'index.php'; $sqlinject = new sql_inject('./log_file_sql.log',$bDestroy_session,$url_redirect); session_start(); error_reporting(0); include_once('./kev/pdo.php'); if(isset($_SESSION['User'])) { $User = $_SESSION['User']; $stmt = $con->prepare("SELECT * FROM usuarios WHERE Username = :usuario"); $stmt->bindParam(':usuario', $User, PDO::PARAM_STR); $stmt->execute(); while($row = $stmt->fetch()) { $name = $row['Username']; $faccion = $row['Faccion']; $vz = $row['Moneda']; $score = $row['Nivel']; $money = $row['Money']; $platabanco = $row['Banco']; $ropa = $row['Skin']; $razon = $row['razon']; $ban = $row['Baneado']; $Conexion = $row['Conexion']; } $dinerototal = $money+$platabanco; } $us = $_GET['p']; $stm = $con->prepare("SELECT * FROM usuarios WHERE Username = :us"); $stm->bindParam(':us', $us, PDO::PARAM_STR); $stm->execute(); while($perfil = $stm->fetch()) { $name_p = $perfil['Username']; $score_p = $perfil['Nivel']; $online_p = $perfil['Online']; $horasjugadas_p = $perfil['horasjugadas']; $Registro_p = $perfil['Registro']; $Conexion_p = $perfil['Conexion'];
		...
		$email = $datos['Email'];
$ropa_p = $perfil['Skin']; $id = $row["ID"]; $votostotales = $perfil["votostotales"]; $valortotal = $perfil["valortotal"];  } $dia_a = substr($Registro_p, 0, 2); $mes_a = substr($Registro_p, 3, 2); $ano_a = substr($Registro_p, 6, 4); $dia_b = substr($Conexion_p, 0, 2); $mes_b = substr($Conexion_p, 3, 2); $ano_b = substr($Conexion_p, 6, 4); $st = $con->prepare("SELECT * FROM logros WHERE nombre = :us"); $st->bindParam(':us', $us, PDO::PARAM_STR); $st->execute(); while($logros = $st->fetch()) { $fecha_nivel = $logros['fecha_nivel']; $sobre_ruedas = $logros['sobre_ruedas']; $fecha_ruedas = $logros['fecha_ruedas']; $automedicado = $logros['automedicado']; $nro_remedio = $logros['nro_remedio']; $fecha_remedio = $logros['fecha_remedio']; $adicto_crack = $logros['adicto_crack']; $nro_crack = $logros['nro_crack']; $fecha_crack = $logros['fecha_crack']; $medico = $logros['medico']; $nro_salvado = $logros['nro_salvado']; $fecha_salvado = $logros['fecha_salvado']; $tortuga = $logros['tortuga']; $fecha_tortuga = $logros['fecha_tortuga']; $techo_propio = $logros['techo_propio']; $fecha_techo = $logros['fecha_techo']; $iniciando_negocios = $logros['iniciando_negocios']; $fecha_negocio = $logros['fecha_negocio']; $lugar_trabajo = $logros['lugar_trabajo']; $fecha_trabajo = $logros['fecha_trabajo']; $cerrajero = $logros['cerrajero']; $nro_forzado = $logros['nro_forzado']; $fecha_forzado = $logros['fecha_forzado']; $piloto_experto = $logros['piloto_experto']; $ganadas = $logros['ganadas']; $fecha_ganadas = $logros['fecha_ganadas']; $negocio_redondo = $logros['negocio_redondo']; $cosecha = $logros['cosecha']; $fecha_cosecha = $logros['fecha_cosecha']; $marihuanero = $logros['marihuanero']; $porros = $logros['porros']; $fecha_porros = $logros['fecha_porros']; $mensaje_perfil = $logros['mensaje']; $pais_perfil = $logros['pais']; $mes_perfil = $logros['mes']; $dia_perfil = $logros['dia']; $ano_perfil = $logros['ano']; $mostrar_perfil = $logros['mostrar_edad']; $color_perfil = $logros['perfil']; } $edadperfil = 2016-$ano_perfil; ?>
...
<link rel="stylesheet" href="../css/rating-star.css" media="all" rel="stylesheet" type="text/css"/>
...
<div class="pdiv">
<div class="sdiv" style="background-image:url(../imagenes/personajes-237/<?php echo $ropa_p ?>.png)"><img src="../imagenes/personajes-237/00.png">
</div>
...
<div class="cdiv">
<?php if($votostotales == 0 && $valortotal == 0){ ?>
<center id="calificaciones">Este jugador aún no fue calificado.</center>
<input id="rating-input" type="number" value="<?php echo $vredondo ?>" style="margin-left:65px;" data-show-clear="false"/>
<?php } else { ?>
<center id="">Promedio de <?php $suma = $valortotal/$votostotales; $vredondo=substr($suma,0,4); if($vredondo == 1){ echo "1 punto";} else { echo "$vredondo puntos";}?> en <?php if($votostotales == 1){ echo "1 calificacion";} else { echo "$votostotales calificaciones";} ?>.</center>
<input id="rating-input" type="number" value="<?php echo $vredondo ?>" style="margin-left:65px;" data-show-clear="false"/>
<?php } ?>
</div>
...
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;<?php echo $score_p ?>0&nbsp;&nbsp;</span>
...
<div class="logrodesc">Alcanzar el nivel <?php echo $score_p ?>.</div>
</div>
...
<div class="logrodesc">Comprar tu primer vehículo.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/2.png);">
...
<div class="logrodesc" style="color:#727272">Comprar tu primer vehículo.</div>
</div>
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/9.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;20&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Automedicado</span></div>
<div class="logrodesc" style="color:#727272">Consumir 50 medicamentos.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Consumir 50 gramos de crack.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/10.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;20&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Adicto al crack</span></div>
<div class="logrodesc" style="color:#727272">Consumir 50 gramos de crack.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;30&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas></div>
<div class="logroiz">
...
<div class="logrodesc">Salvar la vida de 15 personas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/11.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;30&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Medico profesional</span></div>
<div class="logrodesc" style="color:#727272">Salvar la vida de 15 personas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;50&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas></div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#<?php echo $color_fondos ?>;" class="logrotit"> Pesca mayor</span></div>
<div class="logrodesc">Pescar una tortuga de 310Kg en el sur de Los Santos.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/12.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;50&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Tortuga mayor</span></div>
<div class="logrodesc" style="color:#727272">Pescar una tortuga de 310Kg en el sur de Los Santos.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Comprar una casa en San Andreas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/5.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;20&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Techo propio</span></div>
<div class="logrodesc" style="color:#727272">Comprar una casa en San Andreas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Comprar un restaurante en San Andreas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/3.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;30&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Iniciando negocios</span></div>
<div class="logrodesc" style="color:#727272">Comprar un restaurante en San Andreas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Comprar una oficina en San Andreas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/4.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;20&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Lugar de trabajo</span></div>
<div class="logrodesc" style="color:#727272">Comprar una oficina en San Andreas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Forzar la cerradura de 10 casas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/1.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;20&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Cerrajero nocturno</span></div>
<div class="logrodesc" style="color:#727272">Forzar la cerradura de 10 casas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Ganar 3 carreras en el estadio de Las Venturas.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/7.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;30&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Piloto experto</span></div>
<div class="logrodesc" style="color:#727272">Ganar 3 carreras en el estadio de Las Venturas.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Cosechar 10 plantas de marihuana.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/6.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;10&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Negocio redondo</span></div>
<div class="logrodesc" style="color:#727272">Cosechar 10 plantas de marihuana.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<div class="logrodesc">Fumar 30 porros.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/8.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;30&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Marihuanero</span></div>
<div class="logrodesc" style="color:#727272">Fumar 30 porros.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<?php if($borracho == 1){?>
<div class="logrotd">
<div data-percent="100" class="chart easyPieChart" style="background-image:url(../imagenes/logros/13.png);">
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;10&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas></div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#<?php echo $color_fondos ?>;" class="logrotit"> Maestro cervecero</span></div>
<div class="logrodesc">Participar en la fiesta de la cerveza.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
<div class="logrofecha completado completado13">Completado</div>
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/13.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;10&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Maestro cervecero</span></div>
<div class="logrodesc" style="color:#727272">Participar en la fiesta de la cerveza.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<?php if($caramelos == 1){?>
<div class="logrotd">
<div data-percent="100" class="chart easyPieChart" style="background-image:url(../imagenes/logros/14.png);">
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;50&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas></div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#<?php echo $color_fondos ?>;" class="logrotit"> Dulce o truco</span></div>
<div class="logrodesc">Conseguir dulces de todos los puestos de Halloween.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
<div class="logrofecha completado completado13">Completado</div>
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/14.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;50&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Dulce o truco</span></div>
<div class="logrodesc" style="color:#727272">Conseguir dulces de todos los puestos de Halloween.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<?php if($hechizado == 1){?>
<div class="logrotd">
<div data-percent="100" class="chart easyPieChart" style="background-image:url(../imagenes/logros/15.png);">
<span style="background-color:#<?php echo $color_fondos ?>">&nbsp;10&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas></div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#<?php echo $color_fondos ?>;" class="logrotit"> Hechizado</span></div>
<div class="logrodesc">Conseguir un sombrero descartable durante Halloween.</div>
</div>
<div style="width: 290px; float:left; border-left:1px solid #d6d6d6; height:84px; position:relative">
<div style="position:absolute; bottom:0">
<div class="logrofecha completado completado13">Completado</div>
...
<?php } else { ?>
<div class="logrotd2">
<div data-percent="0" class="chart easyPieChart" style="background-image:url(../imagenes/logros/15.png);">
<div class="logroni"></div> <span style="background-color:#<?php echo $color_fondos ?>">&nbsp;10&nbsp;&nbsp;</span>
<canvas height="84" width="84"></canvas>
</div>
<div class="logroiz">
<div style="float:left;	width: 550px;"><span style="background-color:#cacaca;" class="logrotit"> Hechizado</span></div>
<div class="logrodesc" style="color:#727272">Conseguir un sombrero descartable durante Halloween.</div>
</div>
<div style="width: 290px; float:left; height:84px; position:relative"></div>
</div>
<?php } ?>
...
<script>
<?php if(isset($_SESSION['User'])) { $uno = '"Muy Malo"'; $dos = '"Malo"'; $tres = '"Bueno"'; $cuatro = '"Muy Bueno"'; $cinco = '"Exelente"'; ?>    
	    jQuery(document).ready(function () {
        $('#rating-input').rating({
			starCaptions: {1: "Muy malo", 2: "Malo", 3: "Bueno", 4: "Muy bueno", 5: "Excelente"<?php if($vredondo > 1 && $vredondo < 2){ echo ", $vredondo: $uno";} if($vredondo > 2 && $vredondo < 3){ echo ", $vredondo: $dos";} if($vredondo > 3 && $vredondo < 4){ echo ", $vredondo: $tres";} if($vredondo > 4 && $vredondo < 5){ echo ", $vredondo: $cuatro";} if($vredondo > 5 && $vredondo < 6){ echo ", $vredondo: $cinco";}?>},
              min: 0,
              max: 5,
              step: 1,
              size: 'xs'
	...
	jQuery(document).ready(function () {
        $('#rating-input').rating({
           ...
           $("#rating-input").on("rating.change", function(event, value, caption) {
			   			   	alert("Ingresa con tu cuenta para calificar.");
