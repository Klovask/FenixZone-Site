...
<p><input type="text" name="username" value="" placeholder="Nombre de usuario" 

<p><input type="password" name="password" value="" placeholder="Contrase&ntilde;a" 
...
<p>¿Olvidaste la contrase&ntilde;a? <a href="perdida.php">Click aqu&iacute; para recuperarla</a>.</p>
<p>¿No tienes cuenta? <a href="nuevo.php">Click aqu&iacute; para crearte una</a>.</p>
</div>
</section>
</div>
